...
const Home = () => {
  return (
    <section className="w-full flex-center flex-col ">
      ...
      <h1 className="head_text text-center dark:text-gray-200 " style={{fontFamily:'prompt',fontWeight:'700'}}>
        Discover & Share 
